...
OUTPUT_LMDB="${OUTPUT_LMDB:-/data/datasets/turbodiff_datasets_and_ckpt/my_turbo-t2av/scm_latent_teacher_1000}"
PREVIEW_DIR="${PREVIEW_DIR:-/data/datasets/turbodiff_datasets_and_ckpt/my_turbo-t2av/scm_latent_teacher_1000_preview}"
